...
class PoseNet(nn.Module):
    ...
    def __init__(self,output_move=True):
        ...
        #     self.predict_mask4 = nn.Conv2d(upconv_planes[1], 3, kernel_size=3, padding=1)
        #     self.predict_mask3 = nn.Conv2d(upconv_planes[2], 3, kernel_size=3, padding=1)
        #     self.predict_mask2 = nn.Conv2d(upconv_planes[3], 3, kernel_size=3, padding=1)
        #     self.predict_mask1 = nn.Conv2d(upconv_planes[4], 3, kernel_size=3, padding=1)
