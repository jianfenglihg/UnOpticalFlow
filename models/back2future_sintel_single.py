...
class Model(nn.Module):
    def __init__(self, nlevels):
        ...
        self.decoder_fwd5 = conv_dec_block(209)
       
        self.decoder_fwd4 = conv_dec_block(177)
    ...
    def forward(self, im_tar, im_ref):
        ...
        corr4_fwd = self.corr(feat4a, feat4b)
        corr4_fwd = corr4_fwd.index_select(1,self.idx_fwd)

        upfeat4_fwd = torch.cat((corr4_fwd, feat4a), 1)
